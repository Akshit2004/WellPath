      ...
      >
        ...
        <div className="relative z-20 p-12 text-white max-w-lg">
          <h2 className="text-5xl font-bold mb-6 leading-tight">
            Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">WellPath</span>
          </h2>
          <p className="text-lg text-gray-300 leading-relaxed">
            Your journey to wellness starts here. Track your habits, achieve your goals, and transform your life with our intelligent platform.
          </p>
        </div>
      </div>
